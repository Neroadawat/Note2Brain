...
SCHEMA_PATH = Path('C:/Users/HP/Documents/GitHub/Note2Brain/backend/prisma/schema.prisma')
...
class Prisma(SyncBasePrisma):
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'C:/Users/HP/Documents/GitHub/Note2Brain/backend/prisma/schema.prisma',
        }
